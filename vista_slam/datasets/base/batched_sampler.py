...
class BatchedRandomSampler:
    ...
    def __iter__(self):
        ...
        feat_idxs = rng.integers(self.pool_size, size=n_batches)   # shape = (n_batches,)
        feat_idxs = np.broadcast_to(feat_idxs[:, None], (n_batches, self.batch_size))  # shape = (n_batches, batch_size)
