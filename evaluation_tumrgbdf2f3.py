...
if __name__ == "__main__":
    ...
    dataset_name = "tumrgbdf2f3"
    scene_names = ['freiburg2_360_hemisphere','freiburg2_360_kidnap', 'freiburg2_desk', 'freiburg2_large_with_loop', 'freiburg2_rpy', 'freiburg2_xyz', 
                   'freiburg3_cabinet', 'freiburg3_large_cabinet', 'freiburg3_long_office_household', 'freiburg3_teddy']
    ...
    for scene_name in scene_names:
        ...
        dataset = SLAM_TUMRGBD(f"{cfg.dataset_folder}/rgbd_dataset_{scene_name}", resolution=(224,224))
        stride = cfg.stride
        slam = OnlineSLAM(
