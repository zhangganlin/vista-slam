...
if __name__ == "__main__":
    ...
    from vista_slam.datasets.slam_scannet import SLAM_Scannet
    ...
    scene_names = ['0000', '0059', '0106', '0169', '0181', '0207']
    # scene_names = ['office']
    ...
    for scene_name in scene_names:
        dataset = SLAM_Scannet(f"{cfg.dataset_folder}/scans/scene{scene_name}_00", resolution=(224,224))
        stride = cfg.stride
        slam = OnlineSLAM(
